...
abstract class UserService extends Service
{
     ...
     */
    public static function get($filter): UserGetDto|false
    {
        ...
        if ($cache === '') {
            ...
            return new UserGetDto(json_decode($cache, true), true);
        }
        ...
        $userDto = new UserGetDto($user, true);
    ...
    public static function create(array $data, bool $transaction = true): UserGetDto
    {
        ...
        try {
            ...
            $systemSalt = ParameterService::load('env_system_salt');
